...
const SellerDashboard = () => {
    ...
    // Seller dashboard chart-i de eyni prinsip ile isleyir: series data, options gorunusdur.
    const state = {
        series : [
            {
                name : "Orders",
        ...
        options : {
            ...
            responsive : [
                {
                    // Mobile ekranda bar chart horizontal formada gosterilir.
                    breakpoint : 565,
                    yaxis : {
                        categories : ['Jan','Feb','Mar','Apl','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']
                    },
    ...
    return (
        <div className='px-2 md:px-7 py-5'>
            ...
            {/* react-apexcharts bu props-lari ApexCharts kitabxanasina oturur. */}
    ...
    <table className='w-full text-sm text-left text-[#d0d2d6]'>
        ...
        <tbody>
	            {
                // Bu order setirleri helelik statikdir, sonra API-dan gelen dataya cevrilecek.
