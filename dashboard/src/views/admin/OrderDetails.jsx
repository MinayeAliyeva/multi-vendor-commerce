...
const OrderDetails = () => {
    return (
        ...
        <div className='w-full p-4 bg-[#6a5fdf] rounded-md'>
            {/* Order-in statusunu admin buradan deyise bilecek. */}
        ...
        <div className='p-4'>
            <div className='flex gap-2 text-lg text-[#d0d2d6]'>
	            ...
	            {/* Sol teref customer delivery/payment xulasasi ucundur. */}
...
Mankato Mississippi </span></p> 
	    ...
	    {/* Sag teref seller-lere bolunmus order item-larini gostermek ucundur. */}
	    <div className='w-[70%]'>
        <div className='pl-3'>
