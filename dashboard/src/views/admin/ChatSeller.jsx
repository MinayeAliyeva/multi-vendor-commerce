...
const ChatSeller = () => {
    ...
    // Mobile-da seller list panelini acib-baglamaq ucun state.
    ...
    {/* Mobile-da seller list soldan slide edir, md+ ekranda normal sol panel kimi qalir. */}
       ...
       <div className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer`}>
	    ...
	    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
	        <div className='flex justify-between items-center'>
	            {
                // sellerId varsa chat header-de secilen seller-in avatar/status hissesi gorunur.
         ...
         <div className='w-[10px] h-[10px] bg-green-500 rounded-full absolute right-0 bottom-0'></div>
	        ...
	        <div className='py-4'>
	            {/* Mesaj listi fixed height + overflow-y-auto ile scroll olur. */}
