...
const AdminDashboard = () => {
    ...
    // ApexChart ucun data ve ayarlar burada saxlanilir.
    // series chart-da gosterilecek setirlerin/data group-larinin siyahisidir.
    const state = {
        series : [
            {
                name : "Orders",
        ...
        // options chart-in gorunusunu, axis adlarini, legend ve responsive davranisini idare edir.
        options : {
            color : ['#181ee8','#181ee8'],
            plotOptions: {
                radius : 30
            ...
            responsive : [
                {
                    // Ekran 565px-den kicik olanda chart mobile ucun horizontal edilir.
                    breakpoint : 565,
                    yaxis : {
                        categories : ['Jan','Feb','Mar','Apl','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']
                    },
    ...
    return (
        <div className='px-2 md:px-7 py-5'>
            ...
            {/* Chart componenti yuxaridaki options ve series datasini oxuyub bar chart render edir. */}
    ...
    <table className='w-full text-sm text-left text-[#d0d2d6]'>
        ...
        <tbody>
	            {
                // Helelik dummy data map olunur. Backend gelende bu array order list olacaq.
